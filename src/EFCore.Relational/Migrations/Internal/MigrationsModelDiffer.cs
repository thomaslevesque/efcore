...
namespace Microsoft.EntityFrameworkCore.Migrations.Internal
{
    ...
    public class MigrationsModelDiffer : IMigrationsModelDiffer
    {
            ...
            [NotNull] IColumn source, [NotNull] IColumn target, [NotNull] DiffContext diffContext)
        {
            ...
            var sourceTypeMapping = sourceMapping.TypeMapping ?? TypeMappingSource.GetMapping(sourceProperty);
            var targetTypeMapping = targetMapping.TypeMapping ?? TypeMappingSource.GetMapping(targetProperty);
            ...
            bool inline = false)
        {
            ...
            var targetMapping = target.PropertyMappings.First();
            var targetTypeMapping = targetMapping.TypeMapping ?? TypeMappingSource.GetMapping(targetMapping.Property);
